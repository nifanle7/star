...
public class ShiroConfig {
     ...
     * 注意：单独一个ShiroFilterFactoryBean配置会报错的，
    ...
    //    cookie.setMaxAge(webProperties.getShiro().getCookieTimeout());
    //    return cookie;
    //}
    ...
    //    // 设置 session超时时间
    //    sessionManager.setGlobalSessionTimeout(webProperties.getShiro().getSessionTimeout() * 1000L);
